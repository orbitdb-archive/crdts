...
// const Counter = require('../src/ipfs-gcounter.js');
...
// describe('IPFS G-Counter', function() {
//   this.timeout(20000);
//   before((done) => {
//     startIpfs().then((res) => {
//       ipfs = res;
...
//       Counter.create(ipfs, 'A').then((counter) => {
//         assert(counter, null);
...
//       Counter.create(ipfs, 'A').then((counter) => {
//         counter.increment(13).then(() => {
//           // console.log(counter.value);
//           // assert.equal(counter.value, 1);
//           counter.getIpfsHash().then((hash) => {
//             // console.log("hji", hash)
//             // console.log(JSON.stringify(counter._log.items, null, 2));
//             // console.log(hash);
//             done();
//           });
//         })
